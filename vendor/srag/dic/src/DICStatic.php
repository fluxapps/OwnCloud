...
namespace srag\DIC\OwnCloud;

use ilLogLevel;
use ilPlugin;
use srag\DIC\OwnCloud\DIC\DICInterface;
use srag\DIC\OwnCloud\DIC\Implementation\ILIAS52DIC;
use srag\DIC\OwnCloud\DIC\Implementation\ILIAS53DIC;
use srag\DIC\OwnCloud\DIC\Implementation\ILIAS54DIC;
use srag\DIC\OwnCloud\DIC\Implementation\ILIAS60DIC;
use srag\DIC\OwnCloud\DIC\Implementation\LegacyDIC;
use srag\DIC\OwnCloud\Exception\DICException;
use srag\DIC\OwnCloud\Output\Output;
use srag\DIC\OwnCloud\Output\OutputInterface;
use srag\DIC\OwnCloud\Plugin\Plugin;
use srag\DIC\OwnCloud\Plugin\PluginInterface;
use srag\DIC\OwnCloud\Version\Version;
use srag\DIC\OwnCloud\Version\VersionInterface;

/**
 * Class DICStatic
 *
 * @package srag\DIC\OwnCloud
 *
